...
window.extAsyncInit = function () {
  ...
  MessengerExtensions.getContext("752170935271841", function success(thread_context) {
    // success
    //set psid to input
...
function handleClickButtonBooking() {
  $("#btnBooking").on("click", function (e) {
    ...
    if (!check) {
      ...
      $.ajax({
        url: "".concat(window.location.origin, "/set-info-booking-online-messenger"),
        method: "POST",
        data: data,
