...
(function (e) {
  ...
  e.widget("toc.tocify", {
    ...
    _nestElements: function _nestElements(t, s) {
      var i, o, n;
    ...
    _generateHashValue: function _generateHashValue(e, t, s) {
      var i = "",
    ...
    _appendSubheaders: function _appendSubheaders(t, s) {
    ...
    _setEventHandlers: function _setEventHandlers() {
      ...
      this.element.on("click.tocify", "li", function () {
        ...
        "mouseenter.tocify": function mouseenterTocify() {
